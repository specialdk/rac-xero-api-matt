  ...
  try {
    ...
    const trialBalance = {
      ...
      totals: {
        ...
        totalRevenue: 0,
        totalExpenses: 0,
        // Current/Non-current breakdown for proper ratio calculations
        currentAssets: 0,
        nonCurrentAssets: 0,
        bankAccounts: 0,
        fixedAssets: 0,
          ...
          if (row.rowType === "Row" && row.cells && row.cells.length >= 2) {
            ...
            if (
              ...
              if (sectionTitle.includes("bank")) {
                trialBalance.totals.bankAccounts += currentBalance;
                trialBalance.totals.currentAssets += currentBalance; // Bank is liquid
                ...
                trialBalance.totals.fixedAssets += currentBalance;
                ...
                // Investment portfolios are non-current
                trialBalance.totals.nonCurrentAssets += currentBalance;
              } else {
                // Default: assume current if not explicitly non-current
                trialBalance.totals.currentAssets += currentBalance;
              }
              ...
              if (sectionTitle.includes("current liabilit") && !sectionTitle.includes("non")) {
                ...
                // Default: assume current if just "liabilities"
                trialBalance.totals.currentLiabilities += currentBalance;
              }
